...
//    private List<String> genres;
//
//    private String imageName; // <-- Store MinIO file name or URL
//
//    public Game() {}
//
//    public Game(Long id, String name, List<String> genres, String description,
//                Double price, Double discount, String sectionKey, String imageName) {
//        this.id = id;
//        this.name = name;
//        this.description = description;
//        this.price = price;
